...
console.log(`${inventory[i].car_model} was made by ${inventory[i].car_make} in ${inventory[i].car_year}`);
}
...
console.log(`${inventory[lastCar].car_model} was made by ${inventory[lastCar].car_make}`);
